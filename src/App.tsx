...
const App: React.FC = () => {
  ...
  const sortAlhabet = [...goods].sort((good1: string, good2: string) => (
    good1.localeCompare(good2)));
  const sortLength = [...goods].sort((good1: string, good2: string) => (
