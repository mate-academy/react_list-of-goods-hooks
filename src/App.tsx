...
export const App: React.FC = () => {
  ...
  const handleSortAlphabet = () => setSortFilter(SortType.SortAlphabet);
  const handleSortLength = () => setSortFilter(SortType.SortLength);
  const onReverse = () => setIsReverseFilter(!isReverseFilter);
