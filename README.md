...
- Replace `dianakerekesha` with your Github username in the [DEMO LINK](https://dianakerekesha.github.io/react_list-of-goods-hooks/) and add it to the PR description.
