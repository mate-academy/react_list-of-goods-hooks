...
- Replace `Tetiana-Hishchak` with your Github username in the [DEMO LINK](https://Tetiana-Hishchak.github.io/react_list-of-goods-hooks/) and add it to the PR description.
