...
- Replace `Irina-Kulish` with your Github username in the [DEMO LINK](https://Irina-Kulish.github.io/react_list-of-goods-hooks/) and add it to the PR description.
