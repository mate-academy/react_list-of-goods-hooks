...
using hooks. Take all you need from you solution for the previous task.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://tsybulko-natalya.github.io/react_list-of-goods-hooks/) and add it to the PR description.
