...
- Replace `YuliaSabitova` with your Github username in the [DEMO LINK](https://YuliaSabitova.github.io/react_list-of-goods-hooks/) and add it to the PR description.
